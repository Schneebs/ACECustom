...
namespace ACE.Server.Command.Handlers
{
    public static class PlayerCommands
    {
        ...
        [CommandHandler("top", AccessLevel.Player, CommandHandlerFlag.None, "Show current leaderboards", "top qb|level|enl|title|augs|deaths|bank|lum|attr|enlcoins|wenlcoins|mkeys|lkeys|jails|notguilty|pets|shinies")]
